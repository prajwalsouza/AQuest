...
\\textcolor{headingSubTextColor}{\\textsc{\\fontfamily{qag}\\selectfont An attempt to generate different valued questions on the same problem set}}
\\fontfamily{cmss}\\selectfont
\\begin{flushright}\\large \\href{https://prajwalsouza.github.io}{prajwalsouza.github.io}
\\end{flushright}
...
Hence, the solution set is $(''' + var['a2v4'] + ''',\\infty)$
...
studentnames = ['Abdul Hamid Ayan','Abhilash K','Akil  G Rao','Ashlesh B','Aswin E P','Bhuvan','Chaithanya PradeepKumar','Dhiren V Bhandary','Dhruv','Glen Cutinha','Heshamuddin','Jeevottam Mohan Heble',' K Sahaj Rao','K Vaishnavi Hegde ','Karthik Prabhu Bantwal','Krithi','M Suneetha Prabhu','MAANASI M SHASTRI','Mavith Farrel Saldanha','Nihar R.P','P Joshika','Pramod Lingaraj','Rickson Zaniel Dsouza','Rishab Rao','Rithika R. Shetty','Sadhguna Aithal','Sameeksha','Sanjith M Lakkol','Shamith Chandra','Shifali.S.G','Shivani Shetty','Srivathsa Batni','Srujan Acharya','Swastik V Shetty','V Mahitha','Vaishnavi N Jappal','Vaibhav Pratap Singh','Vasthav Alva','Vishnu Alokkan']
shortstudentnames = ['Ayan','Abhilash','Akil','Ashlesh','Aswin','Bhuvan','Chaithanya','Dhiren','Dhruv','Glen','Heshamuddin','Jeevottam',' Sahaj','Vaishnavi Hegde ','Karthik','Krithi','Suneetha','Maanasi','Mavith','Nihar','Joshika','Pramod','Rickson','Rishab','Rithika','Sadhguna','Sameeksha','Sanjith','Shamith','Shifali','Shivani','Srivathsa','Srujan','Swastik','Mahitha','Vaishnavi N','Vaibhav','Vasthav','Vishnu']
